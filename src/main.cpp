...
public:
    ...
    void relatorio()
    {
        ...
        for (int i = 0; i < astronautas.size(); i++)
        {
            ...
            int experiencia = astronautas[i].getExperiencia();
        ...
        {
            cout << "astronauta mais experiente: " << astronautas[posMelhor].getCpf()
                 << " " << astronautas[posMelhor].getNome()
